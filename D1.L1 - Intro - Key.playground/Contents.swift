...
let nameOfScholar = "Mark"
let address = "Brooklyn"
let cityBornIn = "Hong Kong"
var gradeLevel = 28
let birthday = "April 30th"
var age = 37
let eyeColor = "black"
let myFavoriteColor = "green"

//3. Use string interpolation to write at least 3 different sentences about yourself, using at least one variable in each sentence.
print("Hello, my name \(nameOfScholar).  I live in \(address) and I'm currently in the \(gradeLevel) grade.  My favorite color is \(myFavoriteColor)")
...
*/
print("Karina was paid a total of $\(10.25*20.00)")
...
var string3 = "Klossy"
print("\(string3.prefix(1))\(string3.count)\(string3.suffix(1))")
